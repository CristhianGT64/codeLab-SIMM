...
export default function ConfirmarVentas({cart, totals, confirmSale, setShowConfirmModal} : {cart : CartItem[], totals : {subtotal : number, total : number}, confirmSale : () => void, setShowConfirmModal : (show : boolean) => void}) {
    return (
