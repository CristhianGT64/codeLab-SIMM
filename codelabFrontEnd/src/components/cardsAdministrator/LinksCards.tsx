  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        <div className={`w-16 h-16 rounded-full bg-linear-to-br ${data.colorSvg} flex items-center justify-center mb-4`}>
          <svg
        ...
        <p className="mt-2 text-lg font-bold text-[#24364d] grow">
          {data.description}
        </p>
