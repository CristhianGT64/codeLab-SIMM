/*
  ...
  - The values [INVENTARIO] on the enum `EnumTipoOperacionContable` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EnumTipoOperacionContable_new" AS ENUM ('VENTA', 'VENTA_COSTO', 'INVENTARIO_ENTRADA', 'INVENTARIO_DANIO', 'INVENTARIO_CONSUMO_INTERNO', 'INVENTARIO_AJUSTE', 'INVENTARIO_OTRO');
